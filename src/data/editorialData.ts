...
export const STAFF_MEMBERS: StaffMember[] = [
  {
    ...
    badge: "Founder • 1999",
    highlights: ["25+ Years Publishing", "PGA & GCSAA Media Partner", "Military Charity Advocate"],
    bio: "Growing the great game of golf, giving young and beginner golfers a sense of comfort on the course. Publishing charity golf events, and giving sponsors the recognition they deserve for participating in tournaments that make a difference and change lives. Anything to support military golf events and show gratitude for the men and women dedicated to serving our country. Making golf fun, being a rebel visionary with a very traditional game, and assisting the PGA and GCSAA in educating consumers across Florida.",
  },
  {
    id: "greg-wise",
    name: "Greg Wise",
    role: "Managing Editor & Photojournalist",
    badge: "Orlando Golf Academy '99",
    highlights: ["Press Association Award Winner", "911 Memorial Caddie Walk Founder", "Baltusrol & Lancaster Caddie"],
    bio: "Prior to graduating from the Golf Academy of America (Orlando, 1999), Greg joined Florida Golf Central Magazine in its inaugural publishing year and served as Managing Editor. His photojournalism career spans sports reporting for The Daily Southerner and The Montclair Times, earning Press Association honors. Greg remains an active professional caddie at prestigious clubs including Baltusrol Golf Club and Lancaster Country Club, and founded the annual 911 Be A Hero For Zero Memorial Caddie Walk.",
  },
  {
    id: "gerald-white",
    name: "Gerald White",
    role: "Contributing Writer & Columnist",
    badge: "Former NFL Player • Author",
    highlights: ["Dallas Cowboys & Miami Dolphins", "University of Michigan Alum", "Native Blue Bourbon Founder"],
    bio: "Gerald White is a contributing writer for Golf Central Magazine, author, entrepreneur, and lifelong advocate for youth and community development. A former running back at the University of Michigan, Gerald played in the NFL with the Dallas Cowboys and Miami Dolphins. He is the author of 'From Us, Forward: It Starts at Home and Shapes Everything', founder of Native Blue Bourbon, and frequently participates in charity golf tournaments across Central Florida.",
  },
  {
    id: "joel-jackson",
    ...
    badge: "GCSAA Legend",
    highlights: ["20 Years Walt Disney World Superintendent", "Isleworth G&CC with Arnold Palmer", "Florida GCSA Executive Director"],
    bio: "Joel Jackson is a certified golf course superintendent with over four decades of leadership in Florida agronomy. After graduating with the charter class of the University of South Florida and serving as a U.S. Coast Guard Officer, Joel embarked on a storied career that included 20 years with Walt Disney World managing Osprey Ridge and Magnolia courses, collaborating with Arnold Palmer on Isleworth G&CC, and serving as Executive Director of the Florida GCSA and Editor of Florida Green magazine.",
  },
  {
    id: "dave-finn",
    name: "Dave Finn",
    role: "Golf Travel Writer & Photographer",
    badge: "World Hickory Open Gold Medalist",
    highlights: ["6x National Award Recipient", "Visited 24 Countries & 15 US States", "Leading Courses Global Ambassador"],
    bio: "Dave Finn has been in the golf industry for more than 35 years as founder of Golfinn International and travelinggolfer.net. A 6-time national award-winning travel journalist from the Golf Journalists Association of Canada and Travel Media Association of Canada, Dave has covered championship golf across 24 countries and is an international Ambassador for Leading Courses. His proudest playing moment was capturing the gold medal at the World Hickory Open in Scotland.",
  },
  {
    id: "rick-harris",
    name: "Rick Harris",
    role: "Senior Golf Columnist & Historian",
    badge: "U.S. Marine Corps Veteran",
    highlights: ["Korean War Veteran", "Florida Golf Central Writer Since 2000", "Top-10 World Amateur Finisher"],
    bio: "Rick Harris served proudly in the U.S. Marine Corps during the Korean War before graduating from the University of Florida in 1956 and earning dual masters degrees. He founded the Ventura Golf Association and Senior Amateur Golfers Association in Orlando. Rick has contributed to Florida Golf Central Magazine for over 24 years under publisher Terrie Purdum, having won dozens of amateur tournaments including a 10th-place finish out of 3,000+ golfers at the World Amateur in Myrtle Beach.",
  },
];
