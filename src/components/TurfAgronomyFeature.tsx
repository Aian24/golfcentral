...
export const TurfAgronomyFeature: React.FC<TurfAgronomyFeatureProps> = ({
  ...
  return (
    <section className="w-full bg-[#0A1F18] text-white py-16 md:py-24 relative overflow-hidden border-b border-[#C5A059]/20">
      {/* Background Ambience */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#17493A]/30 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b border-[#BFA054]/30 pb-6 gap-4">
          <div>
            <div className="flex items-center space-x-2 text-xs tracking-widest text-[#D4B568] uppercase mb-1 font-semibold">
              <Award className="w-4 h-4 text-[#BFA054]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="relative group overflow-hidden border border-[#BFA054]/40 shadow-2xl bg-black rounded-xl">
              <div className="relative h-[340px] sm:h-[420px] md:h-[480px] w-full">
                ...
                <div className="absolute bottom-4 left-4 right-4 p-4 bg-black/70 backdrop-blur-md border border-[#BFA054]/30 rounded-lg">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
              <div className="p-3 bg-[#06150F] border border-[#BFA054]/25 rounded-xl">
                <Droplets className="w-4 h-4 text-[#BFA054] mb-1.5" />
                <div className="text-[10px] text-white/50 uppercase font-semibold">Hydrology</div>
                <div className="text-xs font-bold text-white">14-18% VWC</div>
                <div className="text-[10px] text-white/60">Moisture Control</div>
              </div>

              <div className="p-3 bg-[#06150F] border border-[#BFA054]/25 rounded-xl">
                <Wind className="w-4 h-4 text-[#BFA054] mb-1.5" />
                <div className="text-[10px] text-white/50 uppercase font-semibold">Sub-Air</div>
                <div className="text-xs font-bold text-white">12.5 Stimpmeter</div>
                <div className="text-[10px] text-white/60">Root Oxygenation</div>
              </div>

              <div className="p-3 bg-[#06150F] border border-[#BFA054]/25 rounded-xl">
                <ShieldCheck className="w-4 h-4 text-[#BFA054] mb-1.5" />
                <div className="text-[10px] text-white/50 uppercase font-semibold">Turf Variety</div>
                <div className="text-xs font-bold text-white">TifEagle &amp; TifTuf</div>
                <div className="text-[10px] text-white/60">-38% Water Usage</div>
              </div>
            </div>
            ...
            <div className="pt-2 flex items-center space-x-4">
              ...
              <span className="text-xs text-[#D4B568] font-medium">
