...
export const PhilanthropySection: React.FC<PhilanthropySectionProps> = ({
  ...
  return (
    <section className="w-full bg-[#0F3D2A] text-white py-16 md:py-24 border-b border-[#176043] relative overflow-hidden">
      {/* Background Accent */}
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#C59B27]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        >
          <div>
            <div className="flex items-center space-x-2 text-xs tracking-widest text-[#D8B045] uppercase mb-1 font-semibold">
              <Flag className="w-4 h-4 text-[#C59B27]" />
          ...
          >
            ...
            <div className="space-y-3 pt-2">
              <motion.div
                ...
                className="flex items-start space-x-3 p-3.5 bg-[#0B291D] border border-white/10 rounded-xl shadow-sm"
              >
                <div className="p-2 bg-[#134E36] text-[#D8B045] rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-xs text-white/70 font-sans mt-0.5 leading-relaxed">
